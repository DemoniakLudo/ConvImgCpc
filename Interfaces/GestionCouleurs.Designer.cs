namespace ConvImgCpc {
	partial class GestionCouleurs {
		...
		private void InitializeComponent() {
			...
			this.modePlus.Location = new System.Drawing.Point(6, 24);
			...
			this.sortPal.Location = new System.Drawing.Point(6, 2);
			...
			this.Controls.Add(this.bpRmoins);
			...
			this.Controls.Add(this.bpCtrstMoins);
			this.Controls.Add(this.bpBplus);
			this.Controls.Add(this.bpVplus);
			this.Controls.Add(this.bpRplus);
			this.Controls.Add(this.bpCtrstPlus);
			this.Controls.Add(this.bpSatMoins);
			this.Controls.Add(this.bpSatPlus);
			this.Controls.Add(this.bpLumMoins);
			this.Controls.Add(this.bpLumPlus);
			this.Controls.Add(this.modePlus);
			this.Controls.Add(this.nb);
			this.Controls.Add(this.sortPal);
			this.Controls.Add(this.RazB);
			this.Controls.Add(this.RazV);
			this.Controls.Add(this.RazR);
			this.Controls.Add(this.bpRazContrast);
			this.Controls.Add(this.reducPal3);
